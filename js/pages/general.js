                    ...
                    <div class="partido_contenedor">
                        ...
                        <div class="progress" style="background: ${agrupacionesColores[agrupacion.idAgrupacion]?.colorLiviano  || "grey"};">
                            <div class="progress-bar"
                                style="width:${agrupacion.votosPorcentaje}%; background: ${agrupacionesColores[agrupacion.idAgrupacion]?.colorPleno|| "black"};">
...
function cargarGraficaResumen(){
    ...
    contenedorGrafico.appendChild(grafico)
        ...
        //<div class="bar" style="--bar-value:${resumen[][1]}%;--bar-color:var(--grafica-gris);" data-name="Otros" title="Other 20%"></div>
